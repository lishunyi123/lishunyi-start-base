...
public class SnowflakeZookeeperHolder {
	...
	private static final String PROP_PATH = null;//System.getProperty("java.io.tmpdir") + File.separator + PropertyFactory.getProperties().getProperty("spring.application.name") + "/leafconf/{port}/workerID.properties";
